...
//
// ReactDOM.render(
//     <LongCommentChecker/>, document.getElementById('root')
// );
...
// // Вопрос:
// //
// // Те пользователи, у которых в стэке пять и более технологий, должны в списке быть отмечены отмечены, как готовые к работе. Что надо вставить вместо XXX, чтобы код работал, как необходимо?
// //
// // copy
// // import React, {ChangeEvent, useState} from 'react';
// // import ReactDOM from 'react-dom';
