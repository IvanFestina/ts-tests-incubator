...
// то надо написать вместо ххх, чтобы после вывода текста в параграф содержимое формы ввода очищалось?
//
// copy
// import React, {useState, MouseEvent, ChangeEvent} from 'react';
// import ReactDOM from 'react-dom';
...
//
// videoName={props.video.title}
// videoContent={props.video.link}
// videoDescription={props.video.description}